...
DEF_HELPER_FLAGS_5(fnmadd_s, 0, f64, env, f64, f64, f64, i32)
DEF_HELPER_FLAGS_5(fnmsub_s, 0, f64, env, f64, f64, f64, i32)

DEF_HELPER_FLAGS_5(fmadd_d,  0, f64, env, f64, f64, f64, i32)
DEF_HELPER_FLAGS_5(fmsub_d,  0, f64, env, f64, f64, f64, i32)
DEF_HELPER_FLAGS_5(fnmadd_d, 0, f64, env, f64, f64, f64, i32)
DEF_HELPER_FLAGS_5(fnmsub_d, 0, f64, env, f64, f64, f64, i32)

DEF_HELPER_FLAGS_4(fadd_s,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_4(fsub_s,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_4(fmul_s,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_4(fdiv_s,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_3(fsqrt_s, 0, f64, env, f64, i32)
DEF_HELPER_FLAGS_3(fmin_s,  0, f64, env, f64, f64)
DEF_HELPER_FLAGS_3(fmax_s,  0, f64, env, f64, f64)

DEF_HELPER_FLAGS_4(fadd_d,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_4(fsub_d,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_4(fmul_d,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_4(fdiv_d,  0, f64, env, f64, f64, i32)
DEF_HELPER_FLAGS_3(fsqrt_d, 0, f64, env, f64, i32)
DEF_HELPER_FLAGS_3(fmin_d,  0, f64, env, f64, f64)
DEF_HELPER_FLAGS_3(fmax_d,  0, f64, env, f64, f64)

DEF_HELPER_FLAGS_3(flt_s, 0, tl, env, f64, f64)
DEF_HELPER_FLAGS_3(fle_s, 0, tl, env, f64, f64)
DEF_HELPER_FLAGS_3(feq_s, 0, tl, env, f64, f64)

DEF_HELPER_FLAGS_3(flt_d, 0, tl, env, f64, f64)
DEF_HELPER_FLAGS_3(fle_d, 0, tl, env, f64, f64)
DEF_HELPER_FLAGS_3(feq_d, 0, tl, env, f64, f64)
